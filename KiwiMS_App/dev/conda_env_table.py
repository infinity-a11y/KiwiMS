...
import json
import subprocess
import importlib.metadata as im  # Built-in for Python 3.8+
import pandas as pd
import requests
from bs4 import BeautifulSoup  # Assuming beautifulsoup4 is installed

print("Starting script...")

fetch_online = True  # Set to False to disable online fetching (faster, but fewer URLs/authors)
