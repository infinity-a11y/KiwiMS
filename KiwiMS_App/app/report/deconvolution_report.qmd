...
box::use(app/logic/conversion_functions[read_decon_result])
result <- read_decon_result(params$result_file)
...
# Spectrum plots are not included in this version of the report
htmltools::p(
  htmltools::em("Spectrum plots are temporarily unavailable in this report version.")
)
```
