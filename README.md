...
<br><br>
## Current Version
<b>KiwiMS 0.7.3</b> <br> <https://github.com/infinity-a11y/KiwiMS/releases/tag/0.7.3>
<br><br>
## Citation
Please cite both **KiwiMS** and **UniDec** if you used this software in your work.
<br><br>
Marian Freisleben. (2026). infinity-a11y/KiwiMS: KiwiMS 0.7.3. Zenodo. DOI: https://doi.org/10.5281/zenodo.16575976
```    
@software{marian_freisleben_2026_16575976,
  author       = {Marian Freisleben},
  title        = {infinity-a11y/KiwiMS: KiwiMS 0.7.3},
  month        = sep,
  year         = 2026,
  publisher    = {Zenodo},
  version      = {0.7.3},
